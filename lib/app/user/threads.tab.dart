...
import 'package:myaniapp/graphql/__gen/user_threads.graphql.dart';
...
class UserThreadsTab extends HookWidget {
  const UserThreadsTab({super.key, required this.id});
                  ...
                  children: [
                    Padding(
                      ...
                      child: GestureDetector(
                        onTap: () =>
                            context.push(Routes.thread(thread.threadId!)),
                        child: Text(
                          thread.thread!.title!,
