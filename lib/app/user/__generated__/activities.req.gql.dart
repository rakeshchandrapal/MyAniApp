...
import 'package:myaniapp/app/user/__generated__/activities.ast.gql.dart' as _i5;
import 'package:myaniapp/app/user/__generated__/activities.data.gql.dart'
    as _i2;
import 'package:myaniapp/app/user/__generated__/activities.var.gql.dart' as _i3;
...
abstract class GUserActivitiesReq
  ...
  factory GUserActivitiesReq(
          [void Function(GUserActivitiesReqBuilder b) updates]) =
  ...
  @override
  Map<String, dynamic> dataToJson(_i2.GUserActivitiesData data) =>
      data.toJson();
