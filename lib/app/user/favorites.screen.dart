...
import 'package:myaniapp/graphql/__gen/user_favorites.graphql.dart';
...
class UserFavoritesScreen extends StatefulHookWidget {
  const UserFavoritesScreen({super.key, required this.name, required this.tab});
      ...
      child: GridView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          return GridCard(
            ...
            onTap: () => context.push(Routes.media(anime.node!.id),
                extra: {"placeholder": anime.node}),
      ...
      child: GridView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          return GridCard(
            ...
            onTap: () => context.push(Routes.media(manga.node!.id),
                extra: {"placeholder": manga.node}),
      ...
      child: GridView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          return GridCard(
            ...
            onTap: () => context.push(Routes.character(character.node!.id),
