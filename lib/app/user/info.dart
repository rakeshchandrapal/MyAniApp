                  ...
                  children: [
                    ...
                    ElevatedButton(
                      onPressed: () => context.pushRoute(
                        UserFavoritesRoute(
                            name: user.name, tab: FavoriteTabs.anime.name),
                      ),
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    ElevatedButton(
                      onPressed: () => context.pushRoute(
                        UserFavoritesRoute(
                            name: user.name, tab: FavoriteTabs.manga.name),
                      ),
                      child: const Text("All"),
                    )
                  ],
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    ElevatedButton(
                      onPressed: () => context.pushRoute(
                        UserFavoritesRoute(
                            name: user.name, tab: FavoriteTabs.characters.name),
                      ),
                      child: const Text("All"),
                    )
                  ],
                    ...
                    for (var character in user.favourites!.characters!.nodes!)
                      Padding(
                        ...
                        child: GridCard(
                          ...
                          onTap: () => context.pushRoute(
                            CharacterRoute(
                                id: character.id, placeholder: character),
                          ),
                          aspectRatio: GridCard.listRatio,
                        ),
                      ),
                          ...
                          for (var studio in user.favourites!.studios!.nodes!)
                            Padding(
                              ...
                              child: ActionChip(
                                ...
                                onPressed: () => context
                                    .pushRoute(StudioRoute(id: studio.id)),
                              ),
                            )
                        ],
                      ),
