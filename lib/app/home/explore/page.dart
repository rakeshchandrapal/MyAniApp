              ...
              children: [
                Padding(
                  ...
                  child: TextField(
                    ...
                    onTap: () =>
                        context.pushRoute(SearchRoute(autofocus: true)),
                  ),
                ),
                Padding(
                ...
                _List(
                  ...
                  onTap: () => context.router.pushNamed(
                      "/search/media?sort=${GMediaSort.TRENDING_DESC}"),
                ),
                _List(
                ...
                _List(
                  ...
                  onTap: () => context.router.pushNamed(
                      "/search/media?sort=${GMediaSort.POPULARITY_DESC}"),
                ),
                _List(
                  medias: response.data!.recent!.media!,
                  title: "Recent",
                  onTap: () => context.router
                      .pushNamed("/search/media?sort=${GMediaSort.ID_DESC}"),
                )
              ],
            ),
          );
