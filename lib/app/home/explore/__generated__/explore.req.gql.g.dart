...
class _$GExploreReq extends GExploreReq {
  ...
  factory _$GExploreReq([void Function(GExploreReqBuilder)? updates]) =>
      (new GExploreReqBuilder()..update(updates))._build();
  ...
  _$GExploreReq._(
      ...
      this.context})
      : super._() {
    BuiltValueNullFieldError.checkNotNull(vars, r'GExploreReq', 'vars');
    BuiltValueNullFieldError.checkNotNull(
        operation, r'GExploreReq', 'operation');
    BuiltValueNullFieldError.checkNotNull(
        executeOnListen, r'GExploreReq', 'executeOnListen');
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'GExploreReq')
          ..add('vars', vars)
...
class GExploreReqBuilder implements Builder<GExploreReq, GExploreReqBuilder> {
  ...
  @override
  GExploreReq build() => _build();

  _$GExploreReq _build() {
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'GExploreReq', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
