                ...
                itemBuilder: (context, index) {
                  ...
                  return Comment(
                    ...
                    onAvatarTap: () => context.push(
                        "/user/${comment.user!.name}/info",
                        extra: {"user": comment.user}),
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    if (activity is GListActivity) {
      ...
      return Comment(
        collapsible: false,
        onAvatarTap: () =>
            context.push("/user/${a.user!.name}/info", extra: {"user": a.user}),
        onTap: hasTap
            ? () => context.push("/activity/${a.id}", extra: {"activity": a})
            : null,
      ...
      return Comment(
        ...
        onTap: hasTap
            ? () => context.push("/activity/${a.id}", extra: {"activity": a})
            : null,
        onAvatarTap: () => context.push("/user/${a.messenger!.name}/info",
            extra: {"user": a.messenger}),
      );
    }
