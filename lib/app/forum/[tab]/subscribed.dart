...
class ForumSubscribedPage extends StatelessWidget {
  const ForumSubscribedPage({super.key, this.categoryId});
  ...
  Widget build(BuildContext context) {
    return GQLRequest(
      ...
      operationRequest: GForumsReq((b) => b
        ..requestId = "subscribedForums$categoryId"
        ..vars.sort.add(GThreadSort.REPLIED_AT_DESC)
        ..vars.id = categoryId
