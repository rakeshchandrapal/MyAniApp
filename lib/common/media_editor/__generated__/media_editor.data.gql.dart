...
abstract class GMediaEntryData
  ...
  factory GMediaEntryData([void Function(GMediaEntryDataBuilder b) updates]) =
      _$GMediaEntryData;
...
abstract class GMediaEntryData_MediaList
  ...
  factory GMediaEntryData_MediaList(
          [void Function(GMediaEntryData_MediaListBuilder b) updates]) =
  ...
  GMediaEntryData_MediaList_user? get user;
...
abstract class GMediaEntryData_MediaList_startedAt
  ...
  factory GMediaEntryData_MediaList_startedAt(
      [void Function(GMediaEntryData_MediaList_startedAtBuilder b)
          updates]) = _$GMediaEntryData_MediaList_startedAt;
...
abstract class GMediaEntryData_MediaList_completedAt
  ...
  factory GMediaEntryData_MediaList_completedAt(
      [void Function(GMediaEntryData_MediaList_completedAtBuilder b)
          updates]) = _$GMediaEntryData_MediaList_completedAt;
...
abstract class GMediaEntryData_MediaList_media
  ...
  factory GMediaEntryData_MediaList_media(
          [void Function(GMediaEntryData_MediaList_mediaBuilder b) updates]) =
...
abstract class GMediaEntryData_MediaList_media_title
  ...
  factory GMediaEntryData_MediaList_media_title(
      [void Function(GMediaEntryData_MediaList_media_titleBuilder b)
          updates]) = _$GMediaEntryData_MediaList_media_title;
...
abstract class GMediaEntryData_MediaList_media_coverImage
  ...
  factory GMediaEntryData_MediaList_media_coverImage(
      [void Function(GMediaEntryData_MediaList_media_coverImageBuilder b)
...
abstract class GMediaEntryData_MediaList_media_startDate
  ...
  factory GMediaEntryData_MediaList_media_startDate(
      [void Function(GMediaEntryData_MediaList_media_startDateBuilder b)
...
abstract class GMediaEntryData_MediaList_user
    implements
        Built<GMediaEntryData_MediaList_user,
            GMediaEntryData_MediaList_userBuilder> {
  GMediaEntryData_MediaList_user._();

  factory GMediaEntryData_MediaList_user(
          [void Function(GMediaEntryData_MediaList_userBuilder b) updates]) =
      _$GMediaEntryData_MediaList_user;

  static void _initializeBuilder(GMediaEntryData_MediaList_userBuilder b) =>
      b..G__typename = 'User';

  @BuiltValueField(wireName: '__typename')
  String get G__typename;
  int get id;
  GMediaEntryData_MediaList_user_mediaListOptions? get mediaListOptions;
  static Serializer<GMediaEntryData_MediaList_user> get serializer =>
      _$gMediaEntryDataMediaListUserSerializer;

  Map<String, dynamic> toJson() => (_i1.serializers.serializeWith(
        GMediaEntryData_MediaList_user.serializer,
        this,
      ) as Map<String, dynamic>);

  static GMediaEntryData_MediaList_user? fromJson(Map<String, dynamic> json) =>
      _i1.serializers.deserializeWith(
        GMediaEntryData_MediaList_user.serializer,
        json,
      );
...
abstract class GMediaEntryData_MediaList_user_mediaListOptions
    implements
        Built<GMediaEntryData_MediaList_user_mediaListOptions,
            GMediaEntryData_MediaList_user_mediaListOptionsBuilder> {
  GMediaEntryData_MediaList_user_mediaListOptions._();

  factory GMediaEntryData_MediaList_user_mediaListOptions(
      [void Function(GMediaEntryData_MediaList_user_mediaListOptionsBuilder b)
          updates]) = _$GMediaEntryData_MediaList_user_mediaListOptions;

  static void _initializeBuilder(
          GMediaEntryData_MediaList_user_mediaListOptionsBuilder b) =>
      b..G__typename = 'MediaListOptions';

  @BuiltValueField(wireName: '__typename')
  String get G__typename;
  _i3.GScoreFormat? get scoreFormat;
  static Serializer<GMediaEntryData_MediaList_user_mediaListOptions>
      get serializer =>
          _$gMediaEntryDataMediaListUserMediaListOptionsSerializer;

  Map<String, dynamic> toJson() => (_i1.serializers.serializeWith(
        GMediaEntryData_MediaList_user_mediaListOptions.serializer,
        this,
      ) as Map<String, dynamic>);

  static GMediaEntryData_MediaList_user_mediaListOptions? fromJson(
          Map<String, dynamic> json) =>
      _i1.serializers.deserializeWith(
        GMediaEntryData_MediaList_user_mediaListOptions.serializer,
        json,
...
abstract class GSaveMediaListEntryData
  ...
  factory GSaveMediaListEntryData(
          [void Function(GSaveMediaListEntryDataBuilder b) updates]) =
...
abstract class GSaveMediaListEntryData_SaveMediaListEntry
  ...
  factory GSaveMediaListEntryData_SaveMediaListEntry(
      [void Function(GSaveMediaListEntryData_SaveMediaListEntryBuilder b)
...
abstract class GSaveMediaListEntryData_SaveMediaListEntry_media
  ...
  factory GSaveMediaListEntryData_SaveMediaListEntry_media(
      [void Function(GSaveMediaListEntryData_SaveMediaListEntry_mediaBuilder b)
...
abstract class GDeleteMediaListEntryData
  ...
  factory GDeleteMediaListEntryData(
          [void Function(GDeleteMediaListEntryDataBuilder b) updates]) =
...
abstract class GDeleteMediaListEntryData_DeleteMediaListEntry
  ...
  factory GDeleteMediaListEntryData_DeleteMediaListEntry(
      [void Function(GDeleteMediaListEntryData_DeleteMediaListEntryBuilder b)
