...
import 'fragments/message_activity.graphql.dart';
...
class Query$Activity$activity {
  ...
  bool operator ==(Object other) {
    ...
    if (other is! Query$Activity$activity || runtimeType != other.runtimeType) {
      return false;
    }
    final l$$__typename = $__typename;
    final lOther$$__typename = other.$__typename;
...
class Query$Activity$replies {
  ...
  bool operator ==(Object other) {
    ...
    if (other is! Query$Activity$replies || runtimeType != other.runtimeType) {
      return false;
    }
    final l$pageInfo = pageInfo;
