...
class Variables$Query$Search {
  ...
  factory Variables$Query$Search.fromJson(Map<String, dynamic> data) {
    ...
    if (data.containsKey('yearGreater')) {
      ...
      result$data['yearGreater'] = (l$yearGreater as String?);
    }
    if (data.containsKey('yearLesser')) {
      final l$yearLesser = data['yearLesser'];
      result$data['yearLesser'] = (l$yearLesser as String?);
    }
  ...
  String? get yearGreater => (_$data['yearGreater'] as String?);

  String? get yearLesser => (_$data['yearLesser'] as String?);
