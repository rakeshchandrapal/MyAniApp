...
class Fragment$ThisUser {
  ...
  factory Fragment$ThisUser.fromJson(Map<String, dynamic> json) {
    ...
    return Fragment$ThisUser(
      ...
      favourites: l$favourites == null
          ? null
          : Fragment$ThisUser$favourites.fromJson(
  ...
  final Fragment$ThisUser$favourites? favourites;
...
abstract class CopyWith$Fragment$ThisUser<TRes> {
  ...
  TRes call({
    ...
    Fragment$ThisUser$favourites? favourites,
  ...
  CopyWith$Fragment$ThisUser$favourites<TRes> get favourites;
...
class _CopyWithImpl$Fragment$ThisUser<TRes>
    ...
    Object? $__typename = _undefined,
      ...
      _then(Fragment$ThisUser(
        ...
        favourites: favourites == _undefined
            ...
            : (favourites as Fragment$ThisUser$favourites?),
  ...
  CopyWith$Fragment$ThisUser$favourites<TRes> get favourites {
    ...
    return local$favourites == null
        ? CopyWith$Fragment$ThisUser$favourites.stub(_then(_instance))
        : CopyWith$Fragment$ThisUser$favourites(
...
class _CopyWithStubImpl$Fragment$ThisUser<TRes>
  ...
  CopyWith$Fragment$ThisUser$favourites<TRes> get favourites =>
      CopyWith$Fragment$ThisUser$favourites.stub(_res);
  CopyWith$Fragment$ThisUser$options<TRes> get options =>
...
class Fragment$ThisUser$favourites {
  Fragment$ThisUser$favourites({
    this.anime,
    this.manga,
    this.$__typename = 'Favourites',
  });

  factory Fragment$ThisUser$favourites.fromJson(Map<String, dynamic> json) {
    final l$anime = json['anime'];
    final l$manga = json['manga'];
    final l$$__typename = json['__typename'];
    return Fragment$ThisUser$favourites(
      anime: l$anime == null
          ? null
          : Fragment$ThisUser$favourites$anime.fromJson(
              (l$anime as Map<String, dynamic>)),
      manga: l$manga == null
          ? null
          : Fragment$ThisUser$favourites$manga.fromJson(
              (l$manga as Map<String, dynamic>)),
      $__typename: (l$$__typename as String),
    );
  }

  final Fragment$ThisUser$favourites$anime? anime;

  final Fragment$ThisUser$favourites$manga? manga;
  ...
  bool operator ==(Object other) {
    ...
    if (!(other is Fragment$ThisUser$favourites) ||
        runtimeType != other.runtimeType) {
      return false;
    }
    final l$anime = anime;
...
extension UtilityExtension$Fragment$ThisUser$favourites
    on Fragment$ThisUser$favourites {
  CopyWith$Fragment$ThisUser$favourites<Fragment$ThisUser$favourites>
      get copyWith => CopyWith$Fragment$ThisUser$favourites(
            this,
            (i) => i,
          );
}

abstract class CopyWith$Fragment$ThisUser$favourites<TRes> {
  factory CopyWith$Fragment$ThisUser$favourites(
    Fragment$ThisUser$favourites instance,
    TRes Function(Fragment$ThisUser$favourites) then,
  ) = _CopyWithImpl$Fragment$ThisUser$favourites;

  factory CopyWith$Fragment$ThisUser$favourites.stub(TRes res) =
      _CopyWithStubImpl$Fragment$ThisUser$favourites;

  TRes call({
    Fragment$ThisUser$favourites$anime? anime,
    Fragment$ThisUser$favourites$manga? manga,
    String? $__typename,
  });
  CopyWith$Fragment$ThisUser$favourites$anime<TRes> get anime;
  CopyWith$Fragment$ThisUser$favourites$manga<TRes> get manga;
}

class _CopyWithImpl$Fragment$ThisUser$favourites<TRes>
    implements CopyWith$Fragment$ThisUser$favourites<TRes> {
  _CopyWithImpl$Fragment$ThisUser$favourites(
    this._instance,
    this._then,
  );

  final Fragment$ThisUser$favourites _instance;

  final TRes Function(Fragment$ThisUser$favourites) _then;
  ...
  TRes call({
    ...
    Object? $__typename = _undefined,
      ...
      _then(Fragment$ThisUser$favourites(
        anime: anime == _undefined
            ? _instance.anime
            : (anime as Fragment$ThisUser$favourites$anime?),
        manga: manga == _undefined
            ? _instance.manga
            : (manga as Fragment$ThisUser$favourites$manga?),
        $__typename: $__typename == _undefined || $__typename == null
            ? _instance.$__typename
            : ($__typename as String),
      ));
  CopyWith$Fragment$ThisUser$favourites$anime<TRes> get anime {
    final local$anime = _instance.anime;
    return local$anime == null
        ? CopyWith$Fragment$ThisUser$favourites$anime.stub(_then(_instance))
        : CopyWith$Fragment$ThisUser$favourites$anime(
            local$anime, (e) => call(anime: e));
  }
  ...
  CopyWith$Fragment$ThisUser$favourites$manga<TRes> get manga {
    final local$manga = _instance.manga;
    return local$manga == null
        ? CopyWith$Fragment$ThisUser$favourites$manga.stub(_then(_instance))
        : CopyWith$Fragment$ThisUser$favourites$manga(
            local$manga, (e) => call(manga: e));
  }
}

class _CopyWithStubImpl$Fragment$ThisUser$favourites<TRes>
    implements CopyWith$Fragment$ThisUser$favourites<TRes> {
  _CopyWithStubImpl$Fragment$ThisUser$favourites(this._res);
  ...
  call({
    ...
    String? $__typename,
      ...
      _res;
  CopyWith$Fragment$ThisUser$favourites$anime<TRes> get anime =>
      CopyWith$Fragment$ThisUser$favourites$anime.stub(_res);
  CopyWith$Fragment$ThisUser$favourites$manga<TRes> get manga =>
      CopyWith$Fragment$ThisUser$favourites$manga.stub(_res);
}

class Fragment$ThisUser$favourites$anime {
  Fragment$ThisUser$favourites$anime({
    this.edges,
    this.$__typename = 'MediaConnection',
  });

  factory Fragment$ThisUser$favourites$anime.fromJson(
      Map<String, dynamic> json) {
    final l$edges = json['edges'];
    final l$$__typename = json['__typename'];
    return Fragment$ThisUser$favourites$anime(
      edges: (l$edges as List<dynamic>?)
          ?.map((e) => e == null
              ? null
              : Fragment$ThisUser$favourites$anime$edges.fromJson(
  ...
  final List<Fragment$ThisUser$favourites$anime$edges?>? edges;
  ...
  bool operator ==(Object other) {
    ...
    if (!(other is Fragment$ThisUser$favourites$anime) ||
        runtimeType != other.runtimeType) {
      return false;
    }
    final l$edges = edges;
...
extension UtilityExtension$Fragment$ThisUser$favourites$anime
    on Fragment$ThisUser$favourites$anime {
  CopyWith$Fragment$ThisUser$favourites$anime<
          Fragment$ThisUser$favourites$anime>
      get copyWith => CopyWith$Fragment$ThisUser$favourites$anime(
            this,
            (i) => i,
          );
}

abstract class CopyWith$Fragment$ThisUser$favourites$anime<TRes> {
  factory CopyWith$Fragment$ThisUser$favourites$anime(
    Fragment$ThisUser$favourites$anime instance,
    TRes Function(Fragment$ThisUser$favourites$anime) then,
  ) = _CopyWithImpl$Fragment$ThisUser$favourites$anime;

  factory CopyWith$Fragment$ThisUser$favourites$anime.stub(TRes res) =
      _CopyWithStubImpl$Fragment$ThisUser$favourites$anime;

  TRes call({
    List<Fragment$ThisUser$favourites$anime$edges?>? edges,
    String? $__typename,
  });
  TRes edges(
      Iterable<Fragment$ThisUser$favourites$anime$edges?>? Function(
              Iterable<
                  CopyWith$Fragment$ThisUser$favourites$anime$edges<
                      Fragment$ThisUser$favourites$anime$edges>?>?)
          _fn);
}

class _CopyWithImpl$Fragment$ThisUser$favourites$anime<TRes>
    implements CopyWith$Fragment$ThisUser$favourites$anime<TRes> {
  _CopyWithImpl$Fragment$ThisUser$favourites$anime(
    this._instance,
    this._then,
  );

  final Fragment$ThisUser$favourites$anime _instance;

  final TRes Function(Fragment$ThisUser$favourites$anime) _then;
  ...
  TRes call({
    ...
    Object? $__typename = _undefined,
      ...
      _then(Fragment$ThisUser$favourites$anime(
        edges: edges == _undefined
            ? _instance.edges
            : (edges as List<Fragment$ThisUser$favourites$anime$edges?>?),
        $__typename: $__typename == _undefined || $__typename == null
            ? _instance.$__typename
            : ($__typename as String),
      ));
...
class _CopyWithStubImpl$Fragment$ThisUser$favourites$anime<TRes>
    implements CopyWith$Fragment$ThisUser$favourites$anime<TRes> {
  _CopyWithStubImpl$Fragment$ThisUser$favourites$anime(this._res);
...
class Fragment$ThisUser$favourites$anime$edges {
  Fragment$ThisUser$favourites$anime$edges({
    this.node,
    this.$__typename = 'MediaEdge',
  });

  factory Fragment$ThisUser$favourites$anime$edges.fromJson(
      Map<String, dynamic> json) {
    final l$node = json['node'];
    final l$$__typename = json['__typename'];
    return Fragment$ThisUser$favourites$anime$edges(
      node: l$node == null
          ? null
  ...
  bool operator ==(Object other) {
    ...
    if (!(other is Fragment$ThisUser$favourites$anime$edges) ||
        runtimeType != other.runtimeType) {
      return false;
    }
    final l$node = node;
...
extension UtilityExtension$Fragment$ThisUser$favourites$anime$edges
    on Fragment$ThisUser$favourites$anime$edges {
  CopyWith$Fragment$ThisUser$favourites$anime$edges<
          Fragment$ThisUser$favourites$anime$edges>
      get copyWith => CopyWith$Fragment$ThisUser$favourites$anime$edges(
            this,
            (i) => i,
          );
}

abstract class CopyWith$Fragment$ThisUser$favourites$anime$edges<TRes> {
  factory CopyWith$Fragment$ThisUser$favourites$anime$edges(
    Fragment$ThisUser$favourites$anime$edges instance,
    TRes Function(Fragment$ThisUser$favourites$anime$edges) then,
  ) = _CopyWithImpl$Fragment$ThisUser$favourites$anime$edges;

  factory CopyWith$Fragment$ThisUser$favourites$anime$edges.stub(TRes res) =
      _CopyWithStubImpl$Fragment$ThisUser$favourites$anime$edges;
...
class _CopyWithImpl$Fragment$ThisUser$favourites$anime$edges<TRes>
    implements CopyWith$Fragment$ThisUser$favourites$anime$edges<TRes> {
  _CopyWithImpl$Fragment$ThisUser$favourites$anime$edges(
    this._instance,
    this._then,
  );

  final Fragment$ThisUser$favourites$anime$edges _instance;

  final TRes Function(Fragment$ThisUser$favourites$anime$edges) _then;
  ...
  TRes call({
    ...
    Object? $__typename = _undefined,
      ...
      _then(Fragment$ThisUser$favourites$anime$edges(
...
class _CopyWithStubImpl$Fragment$ThisUser$favourites$anime$edges<TRes>
    implements CopyWith$Fragment$ThisUser$favourites$anime$edges<TRes> {
  _CopyWithStubImpl$Fragment$ThisUser$favourites$anime$edges(this._res);
...
class Fragment$ThisUser$favourites$manga {
  Fragment$ThisUser$favourites$manga({
    this.edges,
    this.$__typename = 'MediaConnection',
  });

  factory Fragment$ThisUser$favourites$manga.fromJson(
      Map<String, dynamic> json) {
    final l$edges = json['edges'];
    final l$$__typename = json['__typename'];
    return Fragment$ThisUser$favourites$manga(
      edges: (l$edges as List<dynamic>?)
          ?.map((e) => e == null
              ? null
              : Fragment$ThisUser$favourites$manga$edges.fromJson(
                  (e as Map<String, dynamic>)))
          .toList(),
      $__typename: (l$$__typename as String),
    );
  ...
  final List<Fragment$ThisUser$favourites$manga$edges?>? edges;
  ...
  bool operator ==(Object other) {
    ...
    if (!(other is Fragment$ThisUser$favourites$manga) ||
        runtimeType != other.runtimeType) {
      return false;
    }
    final l$edges = edges;
...
extension UtilityExtension$Fragment$ThisUser$favourites$manga
    on Fragment$ThisUser$favourites$manga {
  CopyWith$Fragment$ThisUser$favourites$manga<
          Fragment$ThisUser$favourites$manga>
      get copyWith => CopyWith$Fragment$ThisUser$favourites$manga(
            this,
            (i) => i,
          );
}

abstract class CopyWith$Fragment$ThisUser$favourites$manga<TRes> {
  factory CopyWith$Fragment$ThisUser$favourites$manga(
    Fragment$ThisUser$favourites$manga instance,
    TRes Function(Fragment$ThisUser$favourites$manga) then,
  ) = _CopyWithImpl$Fragment$ThisUser$favourites$manga;

  factory CopyWith$Fragment$ThisUser$favourites$manga.stub(TRes res) =
      _CopyWithStubImpl$Fragment$ThisUser$favourites$manga;

  TRes call({
    List<Fragment$ThisUser$favourites$manga$edges?>? edges,
    String? $__typename,
  });
  TRes edges(
      Iterable<Fragment$ThisUser$favourites$manga$edges?>? Function(
              Iterable<
                  CopyWith$Fragment$ThisUser$favourites$manga$edges<
                      Fragment$ThisUser$favourites$manga$edges>?>?)
          _fn);
}

class _CopyWithImpl$Fragment$ThisUser$favourites$manga<TRes>
    implements CopyWith$Fragment$ThisUser$favourites$manga<TRes> {
  _CopyWithImpl$Fragment$ThisUser$favourites$manga(
    this._instance,
    this._then,
  );

  final Fragment$ThisUser$favourites$manga _instance;

  final TRes Function(Fragment$ThisUser$favourites$manga) _then;
  ...
  TRes call({
    ...
    Object? $__typename = _undefined,
      ...
      _then(Fragment$ThisUser$favourites$manga(
        edges: edges == _undefined
            ? _instance.edges
            : (edges as List<Fragment$ThisUser$favourites$manga$edges?>?),
        $__typename: $__typename == _undefined || $__typename == null
            ? _instance.$__typename
            : ($__typename as String),
      ));
...
class _CopyWithStubImpl$Fragment$ThisUser$favourites$manga<TRes>
    implements CopyWith$Fragment$ThisUser$favourites$manga<TRes> {
  _CopyWithStubImpl$Fragment$ThisUser$favourites$manga(this._res);
...
class Fragment$ThisUser$favourites$manga$edges {
  Fragment$ThisUser$favourites$manga$edges({
    this.node,
    this.$__typename = 'MediaEdge',
  });

  factory Fragment$ThisUser$favourites$manga$edges.fromJson(
      Map<String, dynamic> json) {
    final l$node = json['node'];
    final l$$__typename = json['__typename'];
    return Fragment$ThisUser$favourites$manga$edges(
      node: l$node == null
          ? null
          : Fragment$BasicMedia.fromJson((l$node as Map<String, dynamic>)),
      $__typename: (l$$__typename as String),
  ...
  bool operator ==(Object other) {
    ...
    if (!(other is Fragment$ThisUser$favourites$manga$edges) ||
        runtimeType != other.runtimeType) {
      return false;
    }
    final l$node = node;
...
extension UtilityExtension$Fragment$ThisUser$favourites$manga$edges
    on Fragment$ThisUser$favourites$manga$edges {
  CopyWith$Fragment$ThisUser$favourites$manga$edges<
          Fragment$ThisUser$favourites$manga$edges>
      get copyWith => CopyWith$Fragment$ThisUser$favourites$manga$edges(
            this,
            (i) => i,
          );
}

abstract class CopyWith$Fragment$ThisUser$favourites$manga$edges<TRes> {
  factory CopyWith$Fragment$ThisUser$favourites$manga$edges(
    Fragment$ThisUser$favourites$manga$edges instance,
    TRes Function(Fragment$ThisUser$favourites$manga$edges) then,
  ) = _CopyWithImpl$Fragment$ThisUser$favourites$manga$edges;

  factory CopyWith$Fragment$ThisUser$favourites$manga$edges.stub(TRes res) =
      _CopyWithStubImpl$Fragment$ThisUser$favourites$manga$edges;
...
class _CopyWithImpl$Fragment$ThisUser$favourites$manga$edges<TRes>
    implements CopyWith$Fragment$ThisUser$favourites$manga$edges<TRes> {
  _CopyWithImpl$Fragment$ThisUser$favourites$manga$edges(
    this._instance,
    this._then,
  );

  final Fragment$ThisUser$favourites$manga$edges _instance;

  final TRes Function(Fragment$ThisUser$favourites$manga$edges) _then;
  ...
  TRes call({
    ...
    Object? $__typename = _undefined,
      ...
      _then(Fragment$ThisUser$favourites$manga$edges(
        node: node == _undefined
            ? _instance.node
            : (node as Fragment$BasicMedia?),
        $__typename: $__typename == _undefined || $__typename == null
...
class _CopyWithStubImpl$Fragment$ThisUser$favourites$manga$edges<TRes>
    implements CopyWith$Fragment$ThisUser$favourites$manga$edges<TRes> {
  _CopyWithStubImpl$Fragment$ThisUser$favourites$manga$edges(this._res);
...
class FetchMoreOptions$Query$FetchViewer extends graphql.FetchMoreOptions {
  FetchMoreOptions$Query$FetchViewer({required graphql.UpdateQuery updateQuery})
      : super(
...
extension ClientExtension$Query$FetchViewer on graphql.GraphQLClient {
  Future<graphql.QueryResult<Query$FetchViewer>> query$FetchViewer(
      ...
      await this.query(options ?? Options$Query$FetchViewer());
  graphql.ObservableQuery<Query$FetchViewer> watchQuery$FetchViewer(
          [WatchOptions$Query$FetchViewer? options]) =>
      this.watchQuery(options ?? WatchOptions$Query$FetchViewer());
...
graphql_flutter.QueryHookResult<Query$FetchViewer> useQuery$FetchViewer(
        [Options$Query$FetchViewer? options]) =>
    graphql_flutter.useQuery(options ?? Options$Query$FetchViewer());
graphql.ObservableQuery<Query$FetchViewer> useWatchQuery$FetchViewer(
        [WatchOptions$Query$FetchViewer? options]) =>
    graphql_flutter.useWatchQuery(options ?? WatchOptions$Query$FetchViewer());

class Query$FetchViewer$Widget
    extends graphql_flutter.Query<Query$FetchViewer> {
  Query$FetchViewer$Widget({
    widgets.Key? key,
    Options$Query$FetchViewer? options,
    required graphql_flutter.QueryBuilder<Query$FetchViewer> builder,
  }) : super(
          key: key,
          options: options ?? Options$Query$FetchViewer(),
          builder: builder,
        );
}
