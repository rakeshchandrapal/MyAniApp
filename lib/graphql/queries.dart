...
var embedMediaCardQuery = removeFragmentDups(r"""query EmbedMediaCard($id: Int) {
    Media(id: $id) {
        ...MediaFragment
    }
}
...
var recommendationsQuery = removeFragmentDups(r"""query Recommendations(
    $page: Int
    $perPage: Int
...
""""$mediaFragment""""""");
var saveRecommendationQuery = removeFragmentDups(r"""mutation SaveRecommendation(
    $mediaId: Int
...
""""$mediaListOptions""""""");
var homeActivitiesQuery = removeFragmentDups(r"""query HomeActivities(
...
""""$reviewFragment""""""");
var notificationsQuery = removeFragmentDups(r"""query Notifications(
    $page: Int
...
""""$threadFragment""""""");
var forumsQuery = removeFragmentDups(r"""query Forums(
    $page: Int
    $sort: [ThreadSort]
    $id: Int
    $subscribed: Boolean
...
""""$messageActivity""""""");
var characterSearchQuery = removeFragmentDups(r"""query CharacterSearch(
    $page: Int = 1
    $search: String
    $isBirthday: Boolean
...
""""$characterFragment""""""");
var userFavoritesQuery = removeFragmentDups(r"""query UserFavorites(
    $name: String
    $animePage: Int
    $mangaPage: Int
    $characterPage: Int
